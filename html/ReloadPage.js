function reloadWebpage()
{
	...
	xmlhttp.onreadystatechange=function() {
		if (xmlhttp.readyState==4 && xmlhttp.status==200) {
			...
			if (cfarray.length == 0) {
				commonfollowinghtml = "<p class=\"comparison-intro\">\"Oops, no common followings!\"</p>";
			}
			...
			if (mentionlist.length == 0) {
				commonmentionhtml = "<p class=\"comparison-intro\">\"Oops, no common mentions!\"</p>";
			}
			...
			// Draw Gallery
			mediahtml = FormatImageGallery(new Array(responseData.media1, responseData.media2), [responseData.user1displayname, responseData.user2displayname]);
